        ...
        <footer id="contacto" className="pt-32 pb-10 px-6 md:px-12 lg:px-24 w-full relative z-10 overflow-hidden">
            <div className="w-full text-center flex flex-col items-center">
                <h2 className="text-[12vw] md:text-[8vw] font-display font-black uppercase tracking-tighter leading-[0.8] mb-12 scroll-anim-footer opacity-0 translate-y-10">
                    Inicia la<br/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7C3AED] via-[#A855F7] to-[#C4B5FD] filter drop-shadow-[0_0_20px_rgba(124,58,237,0.18)]">Secuencia</span>
                </h2>
                
                <div className="mt-8">
                    <a href="https://wa.me/528331119884" className="scroll-anim-footer opacity-0 translate-y-10 group relative inline-flex items-center justify-center px-12 py-6 md:px-16 md:py-8 font-bold text-white transition-all duration-300 bg-[#7C3AED] rounded-full hover:bg-[#6D28D9] hover:scale-105 interactive-hover overflow-hidden shadow-lg shadow-[#7C3AED]/20">
            ...
            <div className="w-full mt-40 flex flex-col md:flex-row justify-between items-center gap-8 text-sm text-[#1E1B4B]/60 font-mono border-t border-[#DDD6FE] pt-8">
                ...
                <div className="flex gap-8">
                    <a href="https://github.com/oscarlaradev" className="hover:text-[#7C3AED] transition-colors interactive-hover underline underline-offset-4" target="_blank" rel="noreferrer">GITHUB</a>
